    ...
    public static Result actionAnmelden(){
        ...
        if (loginForm.hasErrors()) {
            ...
            if(Status){
                ...
                return ok(memberIndex.render("Du hast Dich erfolgreich angemeldet", session("email"),null, null ,null));
            }else{
    ...
    public static Result actionRegistrierung(){
        ...
        if (regForm.hasErrors()) {
            ...
            if(!newUserData.password.equals(newUserData.repassword))
            {
                ...
                session("email", email);
                session("connected", "true");
                return ok(views.html.memberIndex.render("Hallo " +  user + " " +StatusMessage, session("email"), user,null, null));
            }
        }
