...
public class memberController extends Controller {
    ...
    public static Result showMemberIndex(){
        ...
        //List<User> userDetails = userDB.getUserdataByEmail(email);
        //List<User> userdata = userDB.getUserdataByEmail(email);
        //List<User> userDetails = userDB.getUserDetails(email);

        return ok(views.html.memberIndex.render("Hallo " + user, session("email"), user, null, null));
    }
    ...
    public static Result actionAnbieterMaske(){
        ...
        if (mfgForm.hasErrors()) {
            ...
            return ok(views.html.memberIndex.render( StatusMessage + "ID: " + userID, session("email"), user,null, null));
        }
    }
}
