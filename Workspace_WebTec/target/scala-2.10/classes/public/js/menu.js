   ...
   $(document).ready(
          $('#listeZeigen').click(function(){
              if($('#PanelAnzeigen').hasClass( "navActiv" ))
                  {
                       $('#PanelAnzeigen').css('display', 'none');
                       $('#PanelAnzeigen').removeClass('navActiv');
                  }else{
                       $('#PanelAnzeigen').css('display', 'block');
                       $('#PanelAnzeigen').addClass('navActiv');
                  }
              })
   );
